      ...
      if (result.Status === true) {
        for (let i = 0; i < result.Response.break.length; i++) {
          if (result.Response.break[i].product_image1) {
            result.Response.break[i].product_image1 = 'https://code-php.herokuapp.com/' + result.Response.break[i].product_image1;
          }
          if (result.Response.break[i].product_image2) {
            result.Response[i].product_image2 = 'https://code-php.herokuapp.com/' + result.Response[i].product_image2;
          }
          if (result.Response.break[i].product_image3) {
            result.Response.break[i].product_image3 = 'https://code-php.herokuapp.com/' + result.Response[i].product_image3;
          }
        }
       ...
       console.log(this.productList);
        ...
        for (let j = 0; j < result.Response.promise.products.length; j++) {
          if (result.Response.promise.products[j].item_image1) {
            result.Response.promise.products[j].item_image1 = 'https://code-php.herokuapp.com/' + result.Response.promise.products[j].item_image1;
          }
          if (result.Response.promise.products[j].item_image2) {
            result.Response.promise.products[j].item_image2 = 'https://code-php.herokuapp.com/' + result.Response.promise.products[j].item_image2;
          }
          if (result.Response.promise.products[j].item_image3) {
            result.Response.promise.products[j].item_image3 = 'https://code-php.herokuapp.com/' + result.Response.promise.products[j].item_image3;
          }
        }
      ...
      if (result.Status === true) {
        for (let l = 0; l < result.Response.products.length; l++) {
          if (result.Response.products[l].item_image1) {
            result.Response.products[l].item_image1 = 'https://code-php.herokuapp.com/' + result.Response.products[l].item_image1;
          }
          if (result.Response.products[l].item_image2) {
            result.Response.products[l].item_image2 = 'https://code-php.herokuapp.com/' + result.Response.products[l].item_image2;
          }
          if (result.Response.products[l].item_image3) {
            result.Response.products[l].item_image3 = 'https://code-php.herokuapp.com/' + result.Response.products[l].item_image3;
          }
        }
