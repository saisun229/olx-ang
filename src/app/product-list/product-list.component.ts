      ...
      if (result.Status === true) {
        for (let i = 0; i < result.Response.products.length; i++) {
          if (result.Response.products[i].item_image1) {
            result.Response.products[i].item_image1 = 'https://code-php.herokuapp.com/' + result.Response.products[i].item_image1;
          }
          if (result.Response.products[i].item_image2) {
            result.Response.products[i].item_image2 = 'https://code-php.herokuapp.com/' + result.Response.products[i].item_image2;
          }
          if (result.Response.products[i].item_image3) {
            result.Response.products[i].item_image3 = 'https://code-php.herokuapp.com/' + result.Response.products[i].item_image3;
          }
        }
